...
public class DataFixers {
    ...
    private static void addFixers(DataFixerBuilder builder) {
        ...
        Schema schema170 = builder.addSchema(3201, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new OptionsProgrammerArtFix(schema170));
        Schema schema171 = builder.addSchema(3202, V3202::new);

        builder.addFixer(new AddNewChoices(schema171, "Added Hanging Sign", References.BLOCK_ENTITY));
        Schema schema172 = builder.addSchema(3203, V3203::new);

        builder.addFixer(new AddNewChoices(schema172, "Added Camel", References.ENTITY));
        Schema schema173 = builder.addSchema(3204, V3204::new);

        builder.addFixer(new AddNewChoices(schema173, "Added Chiseled Bookshelf", References.BLOCK_ENTITY));
        Schema schema174 = builder.addSchema(3209, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new ItemStackSpawnEggFix(schema174, false, "minecraft:pig_spawn_egg"));
        Schema schema175 = builder.addSchema(3214, DataFixers.SAME_NAMESPACED);
